...
\title{Polynomial Calculator \\ with lex and yacc} % Report title

\author{\textsc{Luis Alberto Ballado Aradias}} % Author name(s)
...
\begin{center}
	\begin{tabular}{l r}
          \textsc{CENTRO DE INVESTIGACIÓN Y DE ESTUDIOS AVANZADOS DEL IPN}\\
          \hspace{3.3cm} \textsc{UNIDAD TAMAULIPAS}\\
          Course: Tecnologías Computacionales (Sep - Dec 2022) \\ % Date the experiment was performed
	  Professor: \textsc{Dr. Edwyn Javier Aldana Bobadilla} \\ % Partner names
	\end{tabular}
\end{center}
